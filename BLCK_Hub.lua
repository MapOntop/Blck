--[[
Chúc Bạn Có 1 Trải Nghiệm Vui Vẻ.
...
mainopens.Parent = mainopen
 ...
 loki.Image = "rbxassetid://16182237359"
 ...
 Hub.Text = "| Can you know me?|"
 Hub.TextColor3 = Color3.fromRGB(255,153,0)
 Hub.TextSize = 16.000
...
--------------------------------------------------------------------
local Library = Update:Window("ManFace Hub","")
------------------------------------------
